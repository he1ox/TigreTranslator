...
public interface SpanishVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SpanishParser#conjunctionPhrase}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConjunctionPhrase(SpanishParser.ConjunctionPhraseContext ctx);
	/**
	 * Visit a parse tree produced by {@link SpanishParser#interjectionPhrase}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInterjectionPhrase(SpanishParser.InterjectionPhraseContext ctx);
}